        ...
        >
          <div className="bg-black/90 border-2 border-green-500 rounded-lg p-4
            ...
            <div className="relative z-10 flex items-center gap-4">
              <RefreshCw className="w-6 h-6 text-green-500 animate-spin" aria-hidden="true" />

              <div className="flex-1">
                <h4 id="pwa-update-title" className="font-mono text-green-500 text-sm mb-1">
                  NEW VERSION AVAILABLE
                </h4>
                <p id="pwa-update-desc" className="font-mono text-green-300 text-xs">
