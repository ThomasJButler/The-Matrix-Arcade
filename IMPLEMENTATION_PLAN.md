...
- [ ] **R84.P1 [P2, DEMOTED]** 5-second countdown after MenuScene — **per Stream A audit D-P1, this is ALREADY IMPLEMENTED at `GameScene.ts:121`**. Task demoted from P1 → P2 and scope reduced to: live-verify the countdown fires at portal scale (1280×800), tick Pong testing-doc line `[ ] 5-second countdown fires correctly after menu` if it works, close the task. No new scene code unless the countdown fails live.
