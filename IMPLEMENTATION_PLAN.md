...
- [ ] **R83.G2 [P0]** Kill the click-to-play overlay — after pressing PLAY, an overlay layer appears on top of the Phaser canvas, blurs the game, requires an extra click to dismiss. Found on 4/4 games. Likely in `src/lib/phaser/PhaserGame.tsx` or the container that wraps it. Tom: *"remove the click-to-play overlap on all games"*.
