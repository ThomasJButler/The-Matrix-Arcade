...
## Status: R82 open — Playtest refinements: R82.14–R82.19 shipped (height reduction, button swap, close-button removal, width expansion, clickwheel → dashbar morph, visual baselines regenerated darwin + linux with new in-play spec). Remaining: R82.20 (verification). R82.13 continuous-improvement resumes after.
