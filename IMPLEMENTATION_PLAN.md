...
## Status: R82 open — Round 2 playtest refinements: R82.21–R82.26 [x] (portal top-clip + 16:9 full-fill + dashbar redesign + EXIT vs PAUSE split + Trophy icon on clickwheel bottom + Key panel right-of-iPod). R82.27–R82.29 still unchecked. R82.27 (bigger PLAY button) next.
