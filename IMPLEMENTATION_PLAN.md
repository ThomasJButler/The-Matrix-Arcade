...
- **Last Updated**: 12 April 2026 (R29 -- Neo Jump player, platform, and enemy sprite integration from CyberPunk + Doodle RPG packs)
...
- [x] **Neo Jump**: Player character sprites (CyberPunk 24×24, 5 states), platform sprites (Doodle RPG tiles, 5 types), and enemy sprite (Bomba 71×79) integrated with `setDisplaySize` scaling and per-type tinting. Remaining: jetpack sprite, collectible sprites, background layers.
