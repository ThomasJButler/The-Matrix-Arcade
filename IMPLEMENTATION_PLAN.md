...
## Status: R82 open — Playtest refinements: R82.14–R82.18 shipped (height reduction, button swap, close-button removal, width expansion, clickwheel → dashbar morph). Remaining: R82.19 (visual baselines), R82.20 (verification). R82.13 continuous-improvement resumes after.
