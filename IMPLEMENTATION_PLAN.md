...
## Status: R82 open — Round 2 playtest refinements: R82.21–R82.27 [x] (portal top-clip + 16:9 full-fill + dashbar redesign + EXIT vs PAUSE split + Trophy icon on clickwheel bottom + Key panel right-of-iPod + bigger PLAY button on both clickwheel centre and dashbar centre). R82.28–R82.29 still unchecked. R82.28 (visual regression baseline regen) next.
